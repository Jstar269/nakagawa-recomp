...
- **Silent by design.** The public-safe build has no host audio backend and produces no audible sound until a redistributable backend is integrated ([#308](https://github.com/Jstar269/nakagawa-recomp/issues/308) (#301)).
