...
| `hst.ps1`, `hst_manager.ps1` | Included as tooling | HST convenience/compatibility entrypoint and Windows orchestration with fail-closed input validation. Generic title-planning foundations exist below them, but the scripts remain HST-oriented and require user-supplied local inputs; they do not carry those inputs. |
