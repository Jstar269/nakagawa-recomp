...
and the project does not claim a release-grade security posture: treat arbitrary PSP and game inputs as
untrusted until the parser and guest-span hardening work tracked in GitHub Issues is complete.
