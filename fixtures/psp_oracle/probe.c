...
#define PSP_ORACLE_CASE_MUTEX_REFER_UNLOCKED 13
#define PSP_ORACLE_CASE_MUTEX_TIMEOUT_QUANTA 14
#define PSP_ORACLE_CASE_MUTEX_PRIORITY_INHERITANCE 15
#define PSP_ORACLE_CASE_MUTEX_INTERRUPT_CONTEXT 16
