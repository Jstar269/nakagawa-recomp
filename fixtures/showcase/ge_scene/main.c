...
/* Texture coordinates are normalized: in 3D (transformed) mode the GE scales
 * float UVs by the texture scale, 1.0 by default, so 1.0 spans the whole texture
 * once. Texel units here would repeat the texture 64 times across a face. */
static const SceneVertex cube_faces[6][6] = {
    { V(0,0, 0,0,1,-0.8f,-0.8f,0.8f), V(1,0, 0,0,1,0.8f,-0.8f,0.8f), V(1,1, 0,0,1,0.8f,0.8f,0.8f), V(0,0, 0,0,1,-0.8f,-0.8f,0.8f), V(1,1, 0,0,1,0.8f,0.8f,0.8f), V(0,1, 0,0,1,-0.8f,0.8f,0.8f) },
    { V(0,0, 0,0,-1,0.8f,-0.8f,-0.8f), V(1,0, 0,0,-1,-0.8f,-0.8f,-0.8f), V(1,1, 0,0,-1,-0.8f,0.8f,-0.8f), V(0,0, 0,0,-1,0.8f,-0.8f,-0.8f), V(1,1, 0,0,-1,-0.8f,0.8f,-0.8f), V(0,1, 0,0,-1,0.8f,0.8f,-0.8f) },
    { V(0,0, 1,0,0,0.8f,-0.8f,0.8f), V(1,0, 1,0,0,0.8f,-0.8f,-0.8f), V(1,1, 1,0,0,0.8f,0.8f,-0.8f), V(0,0, 1,0,0,0.8f,-0.8f,0.8f), V(1,1, 1,0,0,0.8f,0.8f,-0.8f), V(0,1, 1,0,0,0.8f,0.8f,0.8f) },
    { V(0,0, -1,0,0,-0.8f,-0.8f,-0.8f), V(1,0, -1,0,0,-0.8f,-0.8f,0.8f), V(1,1, -1,0,0,-0.8f,0.8f,0.8f), V(0,0, -1,0,0,-0.8f,-0.8f,-0.8f), V(1,1, -1,0,0,-0.8f,0.8f,0.8f), V(0,1, -1,0,0,-0.8f,0.8f,-0.8f) },
    { V(0,0, 0,1,0,-0.8f,0.8f,0.8f), V(1,0, 0,1,0,0.8f,0.8f,0.8f), V(1,1, 0,1,0,0.8f,0.8f,-0.8f), V(0,0, 0,1,0,-0.8f,0.8f,0.8f), V(1,1, 0,1,0,0.8f,0.8f,-0.8f), V(0,1, 0,1,0,-0.8f,0.8f,-0.8f) },
    { V(0,0, 0,-1,0,-0.8f,-0.8f,-0.8f), V(1,0, 0,-1,0,0.8f,-0.8f,-0.8f), V(1,1, 0,-1,0,0.8f,-0.8f,0.8f), V(0,0, 0,-1,0,-0.8f,-0.8f,-0.8f), V(1,1, 0,-1,0,0.8f,-0.8f,0.8f), V(0,1, 0,-1,0,-0.8f,-0.8f,0.8f) }
};
...
static void setup_graphics(void) {
    ...
    /* Scene ambient light: without it, faces turned away from the directional
     * light render black, because the material ambient is multiplied by it. */
    sceGuAmbient(0xFF404040);
    sceGuAmbientColor(0xFF444444);
