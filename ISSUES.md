...
| P1 | Open | [#23 — PSP DMA copy semantics: validation, overlap, and measured transfer ceiling](https://github.com/Jstar269/nakagawa-recomp/issues/23) — the measured copy/error/prefix contract is implemented; concurrent BUSY behavior and invalid-tail precedence remain hardware-unknown |
