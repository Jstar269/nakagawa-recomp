...
| P1 | Closed | Exotic VFPU NaN/Inf matrix/multiply divergences: [issue #40](https://github.com/Jstar269/nakagawa-recomp/issues/40) probe repaired and settled on PSP-3000 (ARK-5) silicon across 20 runs per vector; sNaN quieting (0x7FC00001), order independence, default invalid NaN (0x7FC00000), and FTZ subnormal flushing established. |
