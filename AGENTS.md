...
- **Dated historical evidence:** kept outside the public candidate; do not
  promote private run logs or handoff notes into evergreen documentation.
...
- Move resolved narratives and superseded hypotheses to the closed issue/PR
  history or a separately reviewed historical record; do not maintain competing
  live trackers in the public candidate.
...
The public candidate records the unresolved PGF/font and PGD/amctrl boundary in
[NOTICE.md](NOTICE.md) and [docs/PUBLIC_SOURCE_PROFILE.md](docs/PUBLIC_SOURCE_PROFILE.md).
Detailed legal/source-comparison packets remain outside the public tree. Do not
...
- **Historical evidence retains dates:** Dated experiment logs, audit snapshots,
  and hardware-oracle records stay in the private evidence lane unless separately
  reviewed for public scope. Never turn an old run into an evergreen claim.
